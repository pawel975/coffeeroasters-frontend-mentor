...
import ImageHeroWhitecupDesktop from '../../assets/about/desktop/image-hero-whitecup.jpg'
  ...
  return (
    <AboutWrapper>
      <div className="introduction">
        ...
        <img className="background-desktop" src={ImageHeroWhitecupDesktop} alt="" />
      ...
      <div className="commitment">
        ...
        <img className="commitment-desktop" src={ImageCommitmentDesktop} alt="" />
        <div className="description">
      ...
      <div className="quality">
        <img className="quality-mobile" src={QualityMobile} alt="" />
        <img className="quality-desktop" src={QualityDesktop} alt="" />
        <div className="description">
